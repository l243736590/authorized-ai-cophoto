...
const copy = {
  zh: {
    ...
    heroTitle: '让你的 AI 合影成为真实',
    heroSubtitle: '明星本人真实授权，区块链上链，真实可验证。',
    heroBody: '每一张合影都记录授权范围、image hash 与链上存证，扫码即可确认：是经过授权的 AI 合成纪念照。',
    proof: ['明星授权', '区块链认证', 'Image Hash', '扫码验证'],
    createCta: '创建合影认证',
    verifyCta: '查看验证页',
    certImageType: '图片类型',
  ...
  ko: {
    ...
    heroTitle: 'AI 투샷을 진짜 인증으로',
    heroSubtitle: '스타 본인의 실제 허가, 블록체인 기록, 공개 검증.',
    heroBody: '모든 투샷은 허가 범위, image hash, 온체인 증명을 기록합니다. QR 스캔으로 허가된 AI 합성 기념 이미지임을 확인할 수 있습니다.',
    proof: ['스타 허가', '블록체인 인증', 'Image Hash', 'QR 검증'],
    createCta: '투샷 인증 만들기',
    verifyCta: '검증 페이지 보기',
